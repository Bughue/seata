...
- [[#8227](https://github.com/apache/incubator-seata/pull/8227)] restore Snap.svg header on PathMap.js, fix NOTICE/LICENSE IPMC findings, and publish official Docker images only from x.x.x-release branches
- [[#8229](https://github.com/apache/incubator-seata/pull/8229)] point LatencyUtils at its own BSD file, sync confirmed console runtime versions, and use npm ci for release frontend builds
